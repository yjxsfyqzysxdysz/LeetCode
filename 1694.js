...
//     res.push(str.slice(i * 3, (i + 1) * 3))
//   }
//   if (afterNum === 4) {
//     res.push(str.slice(-4, -2), str.slice(-2))
//   } else {
//     res.push(str.slice(afterNum * -1))
//   }
//   return res.join('-')
// }
...
console.log(reformatNumber('1234'))
console.log(reformatNumber('12345'))
console.log(reformatNumber('123456'))
console.log(reformatNumber('1234567'))
console.log(reformatNumber('12345678'))
console.log(reformatNumber('123456789'))
console.log(reformatNumber('1234567890'))
